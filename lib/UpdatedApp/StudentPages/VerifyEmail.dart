                        ...
                        onTap: () {
                          ...
                          kIsWeb
                              ...
                              : sendEmail(
                                  ...
                                  'Verification Code',
                                  widget.gender == 'Male'
                                      ? '''<p>Hello Mr ${widget.surname},<br/>We are aware that you are trying to register your account on Accomate App.<br/>Here is your verification code: $verificationCode</p>'''
                                      : '''<p>Hello Mrs ${widget.surname},<br/>We are aware that you are trying to register your account on Accomate App.<br/>Here is your verification code: $verificationCode</p>''',
                                );
                        },
                        child: Text(
                          'Resend code',
